...
import CustomFilters from './FieldWiseModifyFilters';
...
import { useFieldWiseModifyLogic } from './FieldWiseModify.logic';
import { School } from './FieldWiseModify.types';
...
const SchoolInfo = () => {
  ...
  const {
    ...
    handlePdfDownload,
    handlePdfPreview,
  } = useFieldWiseModifyLogic(); // Need to Change This
