...
export const useConcessionStructuringLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<ConcessionStructuringFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<ConcessionStructuringFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: ConcessionStructuringFilters) => {
