...
import CustomFilters from "./ConcessionGroupFilters";
import { useConcessionGroupLogic } from "./ConcessionGroup.logic";




export const ConcessionGroup = () => {
    ...
    const columns: Column[] = [
      {
        field: "first_name", // api response key
        headerName: "Group Name",
        renderInput: true,
      },
      {
        field: "email", // api response key
