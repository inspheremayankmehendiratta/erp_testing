...
import { ConcessionGroupFilters } from './ConcessionGroup.types';


interface FiltersProps {
  filterValues: ConcessionGroupFilters;
  onApply: (values: ConcessionGroupFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: ConcessionGroupFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: ConcessionGroupFilters = filterValues;
