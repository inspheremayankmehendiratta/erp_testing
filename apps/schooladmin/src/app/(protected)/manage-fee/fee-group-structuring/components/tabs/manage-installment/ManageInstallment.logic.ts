...
export const useManageGroupsLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<ManageInstallmentFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<ManageInstallmentFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: ManageInstallmentFilters) => {
