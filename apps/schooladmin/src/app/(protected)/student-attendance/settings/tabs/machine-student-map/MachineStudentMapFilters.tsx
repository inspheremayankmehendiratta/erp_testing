...
interface FiltersProps {
  filterValues: MachineStudentFilters;
  onApply: (values: MachineStudentFilters) => void;
}

const defaultValues: MachineStudentFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: MachineStudentFilters = filterValues;
