...
interface FiltersProps {
  filterValues: AttendanceFilters;
  onApply: (values: AttendanceFilters) => void;
  onReset: (values: AttendanceFilters) => void;
}

const CustomFilters = ({ filterValues, onApply, onReset }: FiltersProps) => {
  const initialValues: AttendanceFilters = filterValues;
              ...
              <Grid size={{ xs: 12, sm: 6, md: 2 }}>
                <Stack direction="row" justifyContent="flex-end" spacing={1} sx={{ mt: 1 }}>
                  <Button
                    ...
                    onClick={() => {
                      const emptyValues: AttendanceFilters = {
                        state: '',
                        name: '',
                      };
