...
import CustomFilters from './AttendanceSummaryFilters';

import { useAttendanceSummaryLogic } from './attendanceSummary.logic';
import { AttendanceSummaryRow } from './attendanceSummary.types';
...
const AttendanceSummary = () => {
    ...
    const {
        ...
        handlePdfDownload,
        handlePdfPreview,
    } = useAttendanceSummaryLogic();

    const [showFilters, setShowFilters] = useState<HTMLElement | null>(null);
    // columns
    const ALL_COLUMNS: ColumnDef<AttendanceSummaryRow>[] = [
    ...
    const columnApiRef = useRef<{
        visibleColumnKeys: (keyof AttendanceSummaryRow | string)[];
        setVisibleColumnKeys: React.Dispatch<React.SetStateAction<(keyof AttendanceSummaryRow | string)[]>>;
