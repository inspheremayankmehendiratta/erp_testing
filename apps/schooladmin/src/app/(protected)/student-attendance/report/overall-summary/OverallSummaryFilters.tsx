...
interface FiltersProps {
    filterValues: OverallSummaryFilters;
    onApply: (values: OverallSummaryFilters) => void;
    onReset: (values: OverallSummaryFilters) => void;
}

const CustomFilters = ({ filterValues, onApply, onReset }: FiltersProps) => {
    const initialValues: OverallSummaryFilters = filterValues;
                            ...
                            <Grid size={{ xs: 12, sm: 6, md: 2 }}>
                                <Stack direction="row" justifyContent="flex-end" spacing={1} sx={{ mt: 3.5 }}>
                                    <Button
                                        ...
                                        onClick={() => {
                                            const emptyValues: OverallSummaryFilters = {
                                                state: '',
                                                name: '',
                                            };
