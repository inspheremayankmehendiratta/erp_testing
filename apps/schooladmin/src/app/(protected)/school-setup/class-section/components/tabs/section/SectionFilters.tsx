...
import { SectionFilters } from './Section.types';


interface FiltersProps {
  filterValues: SectionFilters;
  onApply: (values: SectionFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: SectionFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: SectionFilters = filterValues;
