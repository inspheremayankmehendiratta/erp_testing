...
interface FiltersProps {
  filterValues: ClassSectionsFilters;
  onApply: (values: ClassSectionsFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: ClassSectionsFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: ClassSectionsFilters = filterValues;
