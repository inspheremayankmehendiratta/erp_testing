...
import { ClassFilters } from './Class.types';


interface FiltersProps {
  filterValues: ClassFilters;
  onApply: (values: ClassFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: ClassFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: ClassFilters = filterValues;
