...
import { AcademicSessionFilters, LeaveRemarkFilters } from './LeaveRemark.types';
...
export const useLeaveRemarkLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<LeaveRemarkFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const applyFilters = (values: LeaveRemarkFilters) => {
