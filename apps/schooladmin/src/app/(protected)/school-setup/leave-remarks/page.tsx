...
import CustomFilters from "./LeaveRemarkFilters";
import { useLeaveRemarkLogic } from "./LeaveRemark.logic";
...
const breadcrumbItems = [
  ...
  { label: 'Leave Remarks', path: '#' },
];

export const LeaveRemark = () => {
