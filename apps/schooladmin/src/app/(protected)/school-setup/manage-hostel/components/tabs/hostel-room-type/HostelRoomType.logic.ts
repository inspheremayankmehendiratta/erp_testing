...
export const useHostelRoomTypeLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<ClassSectionHostelFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<ClassSectionHostelFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: ClassSectionHostelFilters) => {
