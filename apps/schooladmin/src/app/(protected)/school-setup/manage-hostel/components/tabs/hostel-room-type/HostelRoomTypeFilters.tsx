...
import { ClassSectionHostelFilters } from './HostelRoomType.types';


interface FiltersProps {
  filterValues: ClassSectionHostelFilters;
  onApply: (values: ClassSectionHostelFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: ClassSectionHostelFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: ClassSectionHostelFilters = filterValues;
