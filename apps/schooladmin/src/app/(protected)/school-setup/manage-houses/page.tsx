...
import CustomFilters from "./ManageHousesFilters";
import { useManageHousesLogic } from "./ManageHouses.logic";
...
const breadcrumbItems = [
    ...
    { label: 'Manage Houses', path: '#' },
];

export const ManageHouses = () => {
