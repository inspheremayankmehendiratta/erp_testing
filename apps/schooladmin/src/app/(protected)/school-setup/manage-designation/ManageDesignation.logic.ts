...
export const useManageDesignationLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<ManageDesignationFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<ManageDesignationFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: ManageDesignationFilters) => {
