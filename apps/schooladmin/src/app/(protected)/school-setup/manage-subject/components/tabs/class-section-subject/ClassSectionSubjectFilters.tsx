...
import { ClassSectionSubjectFilters } from './ClassSectionSubject.types';


interface FiltersProps {
  filterValues: ClassSectionSubjectFilters;
  onApply: (values: ClassSectionSubjectFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: ClassSectionSubjectFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: ClassSectionSubjectFilters = filterValues;
