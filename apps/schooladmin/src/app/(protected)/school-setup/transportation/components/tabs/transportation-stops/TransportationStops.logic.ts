...
export const useTransportationStopsLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<ClassSectionSubjectFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<ClassSectionSubjectFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: ClassSectionSubjectFilters) => {
