...
import { SubjectFilters } from './TransportationRoutes.types';


interface FiltersProps {
  filterValues: SubjectFilters;
  onApply: (values: SubjectFilters) => void;
}
//used to reset the filters to default values when reset button is clicked
const defaultValues: SubjectFilters = {
  first_name: '',
  email: '',
  mobile: '',
  role: '',
...
const CustomFilters = ({ filterValues, onApply }: FiltersProps) => {
  const initialValues: SubjectFilters = filterValues;
