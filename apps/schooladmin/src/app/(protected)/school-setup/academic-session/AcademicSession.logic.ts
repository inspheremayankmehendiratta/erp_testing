...
export const useAcademicSessionLogic = () => {
  ...
  const {
    ...
    changeLimit,
    exportData,
  } = useTableData<AcademicSessionFilters>({
    url:  MANAGE_USER,
    initialFilters: {},
    fileName: fileLabel,
  ...
  const [filterValues, setFilterValues] =
    useState<AcademicSessionFilters>({
      first_name: '',
      email: '',
      mobile: '',
      role: '',
  ...
  const applyFilters = (values: AcademicSessionFilters) => {
